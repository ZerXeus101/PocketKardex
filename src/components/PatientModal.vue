      ...
      >
        ...
        >
          ...
          <div class="space-y-3">
            <!-- Bed Label -->
            <div>
              <label class="text-[11px] font-bold uppercase tracking-wider text-pk-secondary mb-1 block">
                Bed / Room Label *
              </label>
              <input
                v-model="bedNumber"
                ...
                class="w-full h-12 bg-pk-input border border-pk-border rounded-xl px-4 text-base font-semibold text-pk-primary placeholder:text-pk-muted focus:border-emerald-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                class="w-full h-12 bg-pk-input border border-pk-border rounded-xl px-4 text-base text-pk-primary placeholder:text-pk-muted focus:border-emerald-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full bg-pk-input border border-pk-border rounded-xl p-3 text-base text-pk-primary placeholder:text-pk-muted focus:border-emerald-500 focus:outline-none resize-none leading-relaxed"
              />
            </div>
          </div>
          ...
          <div class="pt-2 space-y-3">
            ...
            <button
              ...
              class="w-full h-13 rounded-2xl font-bold text-[16px] tracking-tight flex items-center justify-center gap-2 cursor-pointer transition-colors"
              :class="[
                bedNumber.trim()
                  ? 'btn-press bg-pk-fab text-pk-fab-text shadow-lg shadow-emerald-500/20'
                  : 'bg-pk-subtle text-pk-muted border border-pk-border cursor-not-allowed'
              ]"
            >
            ...
            <div v-if="patient">
              <div v-if="!showDeleteConfirm">
                <button
                  ...
                  type="button"
                  class="btn-press w-full h-11 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-500 hover:text-rose-600 font-semibold text-[13px] flex items-center justify-center gap-2 hover:bg-rose-500/20 cursor-pointer"
                >
                  <Trash2 :size="15" />
              ...
              <div v-else class="p-3.5 bg-rose-500/10 rounded-xl border border-rose-500/25 space-y-2.5">
                ...
                <div class="flex gap-2">
                  <button
                    ...
                    type="button"
                    class="btn-press flex-1 h-9.5 rounded-lg bg-pk-subtle border border-pk-border text-pk-secondary text-[12px] font-semibold cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
